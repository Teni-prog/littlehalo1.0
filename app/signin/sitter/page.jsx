                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24 items-center">
                    ...
                    <div className="bg-white rounded-3xl shadow-xl p-8 md:p-10 border border-gray-100 relative">
                        ...
                        <div className="text-center mt-8 mb-8">
                            <div className="w-16 h-16 bg-teal-500 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-md shadow-red-100">
                        ...
                        <form className="space-y-5">
                            ...
                            <Link href="">
                                <button
                                    type="button"
                                    className="w-full bg-teal-500 text-white py-3.5 rounded-xl font-bold hover:bg-teal-600 transition-colors shadow-lg shadow-teal-100 cursor-pointer"
                                >
                                    Sign In
                                </button>
                            </Link>
