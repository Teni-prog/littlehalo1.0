      ...
      <div className="bg-white border-b px-4 py-4 shrink-0">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row sm:items-center gap-3">
          <div className="flex-1">
            <h1 className="text-2xl font-bold text-gray-900">Browse Sitters</h1>
            <p className="text-sm text-gray-500 mt-0.5">
              {filteredSitters.length} sitter{filteredSitters.length !== 1 ? "s" : ""} found
              {radiusMeters ? ` within ${radiusMeters / 1000} km` : ""}
            </p>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-gray-600 font-medium whitespace-nowrap">Radius:</span>
        ...
        <div className="hidden md:block w-1/2 lg:w-3/5 relative">
          ...
          {!parent?.latitude && (
            <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur-sm border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-600 shadow-sm max-w-xs">
              ...
              Set your neighbourhood during signup to see distances.
            </div>
          )}
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          {filteredSitters.length === 0 ? (
            <div className="bg-white rounded-xl p-8 text-center shadow-sm mt-4">
              <p className="text-gray-500">No sitters found in this radius.</p>
              <button
                onClick={() => setRadiusMeters(null)}
          ...
          <div className="flex items-start justify-between gap-2">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-0.5 flex items-center gap-1">
                ...
                {sitter.neighbourhood || sitter.location || "Location not set"}
              </p>
            </div>
            <div className="text-right shrink-0">
              <p className="font-bold text-[#ff6b6b] text-sm">${sitter.hourly_rate}/hr</p>
