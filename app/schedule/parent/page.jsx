...
const STATUS_CONFIG = {
  pending_sitter: { label: "Pending",            bg: "#FAEEDA", text: "#633806" },
  confirmed:      { label: "Confirmed",          bg: "#E6F1FB", text: "#0C447C" },
  completed:      { label: "Completed",          bg: "#E1F5EE", text: "#085041" },
  cancelled:      { label: "Cancelled/Declined", bg: "#F1EFE8", text: "#5F5E5A" },
  declined:       { label: "Cancelled/Declined", bg: "#F1EFE8", text: "#5F5E5A" },
};
...
export default function ParentSchedule() {
  ...
  const bookings = useMemo(() =>
    rawBookings.map((b) => {
      ...
      const sitterName  = b.sitter_profile?.user?.name || "Sitter";
          ...
          <div className="flex-1 p-6 space-y-5">
            ...
            <div>
              ...
              <p className="font-medium text-gray-900">
                {new Date(`${selectedBk.date}T12:00:00`).toLocaleDateString("en-US", {
                  weekday: "long",
                  year:    "numeric",
                  month:   "long",
                  day:     "numeric",
            ...
            {selectedBk.child && (
              <div>
                ...
                <p className="text-sm text-gray-500">{selectedBk.child.age} years old</p>
              </div>
            )}
  ...
  return (
    <ParentSidebar userName={parentName}>
      <div className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 py-8 w-full">
        {/* Page header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Hello, {parentName}</h1>
          <p className="text-gray-600">Here's your schedule</p>
        </div>
          ...
          <>
            ...
            <div className="mt-4 bg-white rounded-2xl border border-gray-200 p-4">
              <div className="flex flex-wrap gap-5 text-xs font-medium">
                {[
                  { label: "Pending",            bg: "#FAEEDA", text: "#633806" },
                  { label: "Confirmed",          bg: "#E6F1FB", text: "#0C447C" },
                  { label: "Completed",          bg: "#E1F5EE", text: "#085041" },
                  { label: "Cancelled/Declined", bg: "#F1EFE8", text: "#5F5E5A" },
                ].map((s) => (
