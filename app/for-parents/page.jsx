  ...
  return (
    <>
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute top-[5%] left-[10%] w-[550px] h-[550px] bg-[#FFE5B4] rounded-full mix-blend-multiply filter blur-[80px] opacity-35 animate-blob" />
        <div className="absolute top-[30%] right-[5%] w-[450px] h-[450px] bg-[#EFA59A] rounded-full mix-blend-multiply filter blur-[80px] opacity-40 animate-blob animation-delay-2000" />
        <div className="absolute bottom-[10%] left-[40%] w-[500px] h-[500px] bg-[#FFE5B4]/25 rounded-full mix-blend-multiply filter blur-[80px] opacity-30 animate-blob animation-delay-4000" />
        <div className="absolute bottom-[25%] right-[30%] w-[400px] h-[400px] bg-[#EFA59A]/30 rounded-full mix-blend-multiply filter blur-[80px] opacity-20 animate-blob animation-delay-6000" />
      </div>
