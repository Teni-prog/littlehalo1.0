    ...
    <div className="bg-white border border-gray-100 rounded-2xl p-5">
      <div className="flex justify-between items-start mb-3">
        <div className="flex-1">
          ...
          <p className="text-sm text-gray-600">
            {session.child.name}, {session.child.age} years old
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 mb-4 text-sm">
        ...
        <div className="flex items-center gap-2 text-gray-600">
          ...
          <span>{session.hours}h @ ${session.hourlyRate}/hr</span>
        </div>
      </div>
      ...
      {status === "confirmed" && (
        sitterMarkedComplete ? (
          <p className="text-sm text-center text-gray-500 py-2 bg-gray-50 rounded-xl border border-gray-100">
            ✓ Marked complete — waiting for the parent to confirm.
          </p>
        ) : (
          <button
          ...
          >
            {loading === "complete" ? "Marking complete…" : "Mark Complete"}
          </button>
        )
      )}
        ...
        <div className="w-full max-w-4xl">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Manage and review all your bookings
            </p>
          </div>
