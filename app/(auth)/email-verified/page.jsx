    ...
    <>
      ...
      <main className="min-h-[calc(100vh-8rem)] flex items-center justify-center py-8 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-lg">
          {/* Decorative Circle */}
          <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-gradient-to-br from-emerald-100/40 to-[#FFE5B4]/40 rounded-full blur-3xl -z-10" />
          ...
          <div className="relative bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-gray-200/50 p-10 md:p-14">
            ...
            <div className="absolute top-12 right-16 w-2 h-2 bg-[#EFA59A] rounded-full animate-bounce animation-delay-1000" />
            <div className="absolute top-6 left-8 w-2.5 h-2.5 bg-[#FFE5B4] rounded-full animate-bounce animation-delay-2000" />
            ...
            <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
              <div className="flex items-start gap-3 p-3 sm:p-4 bg-gradient-to-r from-[#FFE5B4]/30 to-[#EFA59A]/10 rounded-xl border border-[#E5533D]/20">
                <UserCheck className="w-6 h-6 text-[#E5533D] shrink-0 mt-0.5" />
                <div>
              ...
              <div className="flex items-start gap-3 p-3 sm:p-4 bg-gradient-to-r from-[#FFE5B4]/30 to-[#EFA59A]/10 rounded-xl border border-[#E5533D]/20">
                <Sparkles className="w-6 h-6 text-[#E5533D] shrink-0 mt-0.5" />
                <div>
                  <h3 className="text-sm font-semibold text-gray-900">
            ...
            <Link
              href="/dashboard"
              className="block w-full bg-gradient-to-r from-[#E5533D] to-[#D4442C] text-white py-4 rounded-xl font-semibold hover:shadow-lg hover:shadow-[#E5533D]/30 transition-all text-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#E5533D] focus-visible:ring-offset-2"
            >
