      ...
      <div className="flex flex-col min-h-screen">
          ...
          <div className="container mx-auto grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-foreground font-outfit leading-tight">
                Accessible, Special-Needs-Aware <span className="text-primary">Childcare</span>
              </h1>
              <p className="text-lg text-muted-foreground max-w-xl">
                Connect with verified sitters who understand your family's unique needs. Every session includes growth-focused micro-adventures for your child's development.
              </p>
        ...
        <section className="py-24 container mx-auto px-4 md:px-6">
          <div className="text-center mb-16 space-y-4">
            ...
            <p className="text-xl text-muted-foreground">Everything you need for peace of mind</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="border-none shadow-lg bg-red-100/50 hover:shadow-xl transition-shadow">
              <CardContent className="pt-8 text-center space-y-4">
                ...
                <h3 className="text-xl font-bold text-gray-900">Verified Credentials</h3>
                <p className="text-gray-600">All sitters are background-checked with educator-verified skills.</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-none shadow-lg bg-teal-100/50 hover:shadow-xl transition-shadow">
              <CardContent className="pt-8 text-center space-y-4">
                ...
                <h3 className="text-xl font-bold text-gray-900">Special Needs Expertise</h3>
                <p className="text-gray-600">Find sitters experienced with autism, ADHD, and language barriers.</p>
              </CardContent>
            </Card>
            ...
            <Card className="border-none shadow-lg bg-yellow-100/50 hover:shadow-xl transition-shadow">
              <CardContent className="pt-8 text-center space-y-4">
                ...
                <h3 className="text-xl font-bold text-gray-900">Micro-Adventures</h3>
                <p className="text-gray-600">Every session can include goal-based learning activities for growth.</p>
              </CardContent>
            </Card>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-3 gap-12 relative">
              ...
              <div className="relative text-center space-y-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Find sitters by location and needs</p>
                </div>
              </div>
              ...
              <div className="relative text-center space-y-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">View credentials and expertise</p>
                </div>
              </div>
              ...
              <div className="relative text-center space-y-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Schedule your session directly</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="#" className="hover:text-white transition-colors">Diversity & Inclusion</Link></li>
