  ...
  return (
    <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-6 sm:p-8 mb-8">
      <div className="flex justify-between items-center mb-6">
        ...
        {/* <button className="text-[#ff6b6b] hover:text-[#ff5252] text-sm font-semibold hover:underline cursor-pointer">
          Edit Preferences
        </button> */}
      </div>
      <hr className="mb-6" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600">
              {parent.experience ? `${parent.experience}+ years` : "Any level"}
            </p>
          </div>
        </div>
