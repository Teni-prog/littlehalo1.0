...
const BOOKING_ADVENTURE_RECORDS = [
  ...
  {
    id: "13",
    title: "Calm Corner Breathing",
    description:
      "Guided breathing and mindfulness activities for children with sensory sensitivities",
    category: "Special Needs",
    ageRange: "2-6 years",
    ageMin: 2,
    ageMax: 6,
    ...
    image: "sensory",
    activities: [
      "Bubble breathing (slow exhales)",
      "Weighted blanket relaxation",
      "Gentle stretching",
      "Visual glitter jar focus",
      "Body scan grounding",
    ],
    materials: [
    ...
    specialNeedsTag: "Sensory Sensitivities",
    sitterId: "6",
  },
  {
    id: "14",
    ...
    description:
      "Explore different textures through gentle gardening — soil, leaves, petals, and water",
    category: "Special Needs",
    ageRange: "3-7 years",
    ageMin: 3,
    ageMax: 7,
    ...
    image: "sensory",
    activities: [
      "Touching soil, sand, and pebbles",
      "Planting seeds with fingers",
      "Sorting leaves by texture",
      "Gentle water play",
      "Nature collage",
    ],
    materials: [
  ...
  {
    id: "15",
    title: "Gentle Sound Bath",
    description:
      "Soft music and rhythm exploration to support auditory regulation and focus",
    category: "Special Needs",
    ageRange: "2-6 years",
    ageMin: 2,
    ageMax: 6,
    ...
    image: "sensory",
    activities: [
      "Soft percussion exploration",
      "Humming and vocal resonance",
      "Rhythm matching with hands",
