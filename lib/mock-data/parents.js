export const parents = [
  ...
  },
  {
    ...
    preferences: {
      ageGroups: ["Preschool (3-5y)"],
      languages: ["Mandarin", "English"],
      certifications: ["First Aid/CPR", "Special Needs Experience"],
      maxHourlyRate: 23,
      preferredDays: ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday"],
    },
    child: {
      ...
      age: "4 years old",
      initial: "K",
      tags: ["Sensory Sensitivities"],
      color: "bg-blue-50 text-blue-600",
      notes:
        "Kai is sensitive to loud noises, bright lights, and rough textures. Prefers predictable routines and gentle transitions. Responds well to visual schedules and calming activities.",
    },
  },
  {
    id: "5",
