...
const NAV_ITEMS = [
  { id: "dashboard",  label: "Dashboard",  href: "/profile/Parents",  Icon: LayoutGrid },
  { id: "schedule",   label: "Schedule",   href: "/schedule/parent",  Icon: Calendar },
  { id: "activities", label: "Activities", href: "/microadventure",   Icon: Lightbulb },
  { id: "settings",   label: "Settings",   href: "/settings/parent",  Icon: Settings },
];
      ...
      <div className="w-64 bg-white border-r border-gray-200 flex flex-col fixed h-screen z-40">
        ...
        <div className="p-6 border-b border-gray-200">
          <Link href="/" className="flex items-center gap-3">
            <Image src={Logo} alt="Little Halo Logo" width={40} height={40} className="rounded-lg" />
