        ...
        <div className="relative overflow-hidden rounded-3xl bg-[#1F2937] p-12 text-center">
          ...
          <div className="relative z-10">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
              Ready to Start Your Sitter Career?
            </h2>
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Join 1,500+ sitters earning flexible income while making a real difference in children's lives. 
              Create your profile today—it's free to join.
            </p>
